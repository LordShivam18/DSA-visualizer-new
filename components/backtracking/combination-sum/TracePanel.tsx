...
const actionTone: Record<CombinationSumActionKind, string> = {
  ...
  "choose-candidate": "border-cyan-400/40 bg-cyan-500/10 text-cyan-200",
  overshoot: "border-rose-400/40 bg-rose-500/10 text-rose-200",
...
export default function TracePanel({ step }: Props) {
  return (
    <PanelShell
      title="Trace Panel"
      subtitle="Each snapshot records how the remaining target changes on one branch."
      accent="amber"
    >
