...
import type {
  PermutationsActionKind,
  PermutationsTraceStep,
} from "./generateTrace";
...
const actionTone: Record<PermutationsActionKind, string> = {
...
export default function TracePanel({ step }: Props) {
  return (
    <PanelShell
      title="Trace Panel"
      subtitle="Each snapshot freezes one placement or one undo of the used-mask."
      accent="amber"
    >
