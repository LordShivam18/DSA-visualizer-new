...
import type {
  LetterCombinationsActionKind,
  LetterCombinationsTraceStep,
} from "./generateTrace";
...
const actionTone: Record<LetterCombinationsActionKind, string> = {
  ...
  "choose-letter": "border-cyan-400/40 bg-cyan-500/10 text-cyan-200",
...
export default function TracePanel({ step }: Props) {
  return (
    <PanelShell
      title="Trace Panel"
      subtitle="Each snapshot captures one branch decision or one undo step."
      accent="amber"
    >
