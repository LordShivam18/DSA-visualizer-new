...
const actionTone: Record<ZigzagActionKind, string> = {
  ...
  "write-value": "border-yellow-400/40 bg-yellow-500/10 text-yellow-200",
  ...
  "flip-direction": "border-yellow-400/40 bg-yellow-500/10 text-yellow-200",
    ...
    <div className="glass-card p-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Each snapshot freezes queue order, zigzag slots, and the alternating direction flag.
          </p>
        </div>
      </div>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-[1.15rem] border border-slate-800/80 bg-slate-950/55 p-4">
          ...
          <p className="mt-2 font-mono text-sm text-cyan-200">
            {formatSlotArray(step.state.activeLevelSlots)}
          </p>
        </div>
        <div className="rounded-[1.15rem] border border-slate-800/80 bg-slate-950/55 p-4">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">
      ...
      <div className="mt-5 space-y-3">
        ...
        <ZigzagStrip
          ...
          emptyLabel="No zigzag level has been committed yet."
        />
      </div>
    </div>
  );
