import type { ZigzagTraceStep } from "./generateTrace";
...
const codeLines = [
  ...
  "            q.pop();",
  "            int writeIndex = leftToRight ? index : levelSize - 1 - index;",
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Highlighted C++ lines track the fixed row buffer, mirrored index, queue appends, and direction toggle.
          </p>
        </div>
      </div>
