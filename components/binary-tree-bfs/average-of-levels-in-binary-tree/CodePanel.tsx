import type { AverageTraceStep } from "./generateTrace";
...
const codeLines = [
  ...
  "        }",
  "        answer.push_back(static_cast<double>(levelSum) / levelSize);",
  "    }",
  "    return answer;",
  "}",
];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            The highlighted C++ lines follow the queue operations and level-average math in the trace.
          </p>
        </div>
      </div>
