...
const actionTone: Record<AverageActionKind, string> = {
  ...
  "add-to-sum": "border-amber-400/40 bg-amber-500/10 text-amber-200",
  ...
  "capture-average": "border-emerald-400/40 bg-emerald-500/10 text-emerald-200",
    ...
    <div className="glass-card p-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Each snapshot freezes the queue and the arithmetic state of the active BFS level.
          </p>
        </div>
      </div>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-[1.15rem] border border-slate-800/80 bg-slate-950/55 p-4">
          ...
          <p className="mt-2 font-mono text-sm text-emerald-200">
            {formatAverageArray(step.state.resultAverages)}
          </p>
        </div>
      </div>
      ...
      <div className="mt-5 space-y-3">
        ...
        <AverageStrip
          ...
          emptyLabel="No level average has been saved yet."
        />
      </div>
    </div>
  );
