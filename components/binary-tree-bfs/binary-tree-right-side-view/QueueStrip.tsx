import type { RightViewTreeNode } from "./generateTrace";
  ...
  return (
    <div className="rounded-[1.2rem] border border-slate-800/80 bg-slate-950/55 p-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className={`rounded-full border px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.18em] ${styles.pill}`}>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {isFront ? (
                    <span className={`rounded-full border px-2 py-0.5 text-[10px] uppercase tracking-[0.16em] ${styles.chip}`}>
                      front
                    </span>
                  ) : null}
                  {!isFront && isHighlight ? (
