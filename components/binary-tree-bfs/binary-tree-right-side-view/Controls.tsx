    ...
    <div className="glass-card p-5">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={onReset}
            className="rounded-xl border border-slate-700/80 bg-slate-950/70 px-5 py-2 text-sm font-medium text-slate-200 transition-all hover:border-violet-400/50 hover:text-violet-200"
          >
            Reset
          </button>
        </div>
