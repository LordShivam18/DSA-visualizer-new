...
export default function SlidingWindowCodePanel({
  step,
  description,
  complexity,
  code,
  ...
  return (
    <div className="glass-card p-5">
      ...
      <div className="mt-5 flex flex-wrap gap-2 text-xs">
        <span className={`rounded-full border px-3 py-1 ${chipTone("emerald")}`}>
          {complexity}
        </span>
          ...
          return (
            <div
              ...
              className={[
                ...
                active
                  ? "border border-emerald-400/30 bg-emerald-500/10 text-slate-50 shadow-[0_0_18px_rgba(52,211,153,0.16)]"
