import {
  type SortListActionKind,
  type SortListTraceStep,
} from "./generateTrace";

const actionTone: Record<SortListActionKind, string> = {
  parsed: "border-slate-600 bg-slate-900/70 text-slate-300",
  "enter-sort": "border-cyan-400/40 bg-cyan-500/10 text-cyan-200",
  "find-middle": "border-yellow-400/40 bg-yellow-500/10 text-yellow-200",
  split: "border-yellow-400/40 bg-yellow-500/10 text-yellow-200",
  "base-case": "border-emerald-400/40 bg-emerald-500/10 text-emerald-200",
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Track the current run, split point, and merge decision.
          </p>
        </div>
      </div>
