import type { MinDiffTraceStep } from "./generateTrace";
  ...
  return (
    <div className="glass-card p-5">
      <div className="flex items-center gap-3">
        <span className="h-4 w-1.5 rounded-full bg-yellow-400" />
        <div>
          <h2 className="text-lg font-semibold text-slate-50">Code Panel</h2>
          <p className="text-sm text-slate-400">
            Highlighted C++ lines follow the inorder visit, adjacent comparison, and previous pointer update.
          </p>
        </div>
      </div>
