import type { WordLadderTraceStep } from "./generateTrace";
...
const codeLines = [
  ...
  "            if (seen.count(next) || diffByOne(word, next) != 1) continue;",
  "            seen.insert(next);",
  "            q.push({next, dist + 1});",
  "        }",
  "    }",
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Highlighted lines track target validation, one-letter checks, and BFS layer growth.
          </p>
        </div>
      </div>
