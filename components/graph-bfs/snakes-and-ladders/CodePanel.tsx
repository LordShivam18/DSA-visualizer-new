import type { SnakesAndLaddersTraceStep } from "./generateTrace";
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Highlighted lines follow BFS dequeueing, dice-roll expansion, and portal redirection.
          </p>
        </div>
      </div>
