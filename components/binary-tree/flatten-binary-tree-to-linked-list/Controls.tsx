      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={onNext}
            disabled={!canNext}
            className="rounded-xl bg-amber-400 px-5 py-2 text-sm font-semibold text-slate-950 shadow-[0_0_26px_rgba(251,191,36,0.36)] transition-all hover:bg-amber-300 disabled:cursor-not-allowed disabled:bg-slate-700 disabled:text-slate-400 disabled:shadow-none"
          >
            Next Step
          </button>
          ...
          <div className="flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/70 p-1">
            <button
              ...
              className={`rounded-full px-4 py-1.5 text-xs transition-all ${
                mode === "beginner"
                  ? "bg-amber-400 text-slate-950 shadow-[0_0_16px_rgba(251,191,36,0.65)]"
