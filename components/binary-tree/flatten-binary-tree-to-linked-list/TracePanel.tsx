...
const actionTone: Record<FlattenActionKind, string> = {
  ...
  "no-left": "border-slate-600 bg-slate-900/70 text-slate-300",
  "pick-left": "border-violet-400/40 bg-violet-500/10 text-violet-200",
  "move-predecessor": "border-amber-400/40 bg-amber-500/10 text-amber-200",
  "stitch-right": "border-amber-400/40 bg-amber-500/10 text-amber-200",
  "skip-stitch": "border-slate-600 bg-slate-900/70 text-slate-300",
  "reroute-right": "border-cyan-400/40 bg-cyan-500/10 text-cyan-200",
  "clear-left": "border-emerald-400/40 bg-emerald-500/10 text-emerald-200",
  "mark-flat": "border-emerald-400/40 bg-emerald-500/10 text-emerald-200",
  advance: "border-cyan-400/40 bg-cyan-500/10 text-cyan-200",
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Each step freezes the current pointer rewiring state.
          </p>
        </div>
      </div>
