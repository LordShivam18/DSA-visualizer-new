    ...
    <div className="glass-card p-5">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={onNext}
            disabled={!canNext}
            className="rounded-xl bg-lime-400 px-5 py-2 text-sm font-semibold text-slate-950 shadow-[0_0_26px_rgba(163,230,53,0.34)] transition-all hover:bg-lime-300 disabled:cursor-not-allowed disabled:bg-slate-700 disabled:text-slate-400 disabled:shadow-none"
          >
            Next Step
          </button>
          ...
          <button
            onClick={onReset}
            className="rounded-xl border border-slate-700/80 bg-slate-950/70 px-5 py-2 text-sm font-medium text-slate-200 transition-all hover:border-amber-400/50 hover:text-amber-200"
          >
            Reset
          </button>
        </div>
          ...
          <div className="flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/70 p-1">
            <button
              ...
              className={`rounded-full px-4 py-1.5 text-xs transition-all ${
                mode === "beginner"
                  ? "bg-lime-400 text-slate-950 shadow-[0_0_16px_rgba(163,230,53,0.55)]"
      ...
      <div className="mt-4">
        ...
        <div className="h-2 overflow-hidden rounded-full border border-slate-800 bg-slate-950/80">
          <div
            className="h-full rounded-full bg-gradient-to-r from-cyan-400 via-lime-300 to-amber-300 shadow-[0_0_18px_rgba(132,204,22,0.26)] transition-all duration-300"
