      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Focus on why the search direction changes between the first and last
            boundary passes.
          </p>
        </div>
      </div>
      ...
      <div className="mt-5 grid gap-3 lg:grid-cols-2">
        ...
        <div className="rounded-[1.15rem] border border-slate-800/80 bg-slate-950/55 p-4">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-300">
            The first pass never stops at the first match because it might not
            be the left edge. The second pass never stops at the last match it
            sees either, because it must prove there is no later copy.
          </p>
        </div>
      </div>
    </div>
