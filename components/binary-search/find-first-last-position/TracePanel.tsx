...
const toneByAction = {
  ...
  "start-first": "border-cyan-400/40 bg-cyan-500/10 text-cyan-200",
  "start-last": "border-violet-400/40 bg-violet-500/10 text-violet-200",
  "choose-mid": "border-yellow-400/40 bg-yellow-500/10 text-yellow-200",
  "record-first": "border-emerald-400/40 bg-emerald-500/10 text-emerald-200",
  "record-last": "border-violet-400/40 bg-violet-500/10 text-violet-200",
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Follow the two-pass search as it narrows down the left edge and then
            the right edge of the target block.
          </p>
        </div>
      </div>
