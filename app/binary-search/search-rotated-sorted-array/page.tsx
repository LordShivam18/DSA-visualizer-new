...
export default function SearchRotatedSortedArrayPage() {
  ...
  const [trace, setTrace] = useState<RotatedSearchTraceStep[]>(() =>
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6">
        ...
        <header className="mx-auto flex w-full max-w-4xl flex-col items-center gap-4 text-center">
          <p className="text-xs uppercase tracking-[0.34em] text-slate-500">
            Binary Search / Rotation / Sorted Half Test
          </p>
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-400 md:text-base">
            This visualizer shows why rotation does not break binary search: one
            half of the current window is always still sorted, and that is
            enough information to throw half the window away.
          </p>
        </header>
            ...
            <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px]">
              ...
              <div>
                ...
                <div className="mt-4 rounded-xl border border-slate-800/80 bg-slate-950/55 p-4 text-sm text-slate-400">
                  Distinct values make the sorted-half test especially clear in
                  this problem.
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(0,0.92fr)]">
          <section className="space-y-5">
            ...
            <RotatedArrayVisualizer step={step} />
        ...
        <div className="mx-auto w-full max-w-4xl">
          <div
            className={`glass-card p-5 ${
              step.done && step.state.resultIndex !== -1
