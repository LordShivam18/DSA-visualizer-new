...
import Controls from "../../../components/divide-conquer/sort-list/Controls";
...
import {
  ...
  generateTrace,
  type Mode,
  type SortListTraceStep,
} from "../../../components/divide-conquer/sort-list/generateTrace";

const defaultInput = "4, 2, 1, 3";
...
export default function SortListPage() {
  ...
  const [trace, setTrace] = useState<SortListTraceStep[]>(() =>
  ...
  const displayedResult =
    step.state.result ?? (step.state.mergedSegment.length > 0 ? step.state.mergedSegment : null);
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6">
        ...
        <header className="mx-auto flex w-full max-w-4xl flex-col items-center gap-4 text-center">
          <p className="text-xs uppercase tracking-[0.34em] text-slate-500">
            Divide &amp; Conquer / Linked List / Merge Sort
          </p>
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-400 md:text-base">
            See linked-list merge sort break the list into tiny runs, then stitch
            those runs back together in ascending order.
          </p>
        </header>
        ...
        <div className="mx-auto w-full max-w-4xl">
          <div className="glass-card p-5">
            ...
            <textarea
              ...
              placeholder="Use comma-separated integers like 4, 2, 1, 3"
            />
          ...
          >
            ...
            <div className="rounded-xl bg-slate-950/50 p-4 font-mono text-base">
              <span className={step.done ? "text-emerald-300" : "text-amber-200"}>
                sortedList = {formatList(displayedResult)}
              </span>
            </div>
            ...
            <div className="mt-3 flex flex-wrap gap-4 text-xs text-slate-400">
              ...
              <span>
                Best fit:{" "}
                <span className="font-mono text-slate-200">
                  linked lists merge naturally without index access
                </span>
              </span>
            </div>
          </div>
