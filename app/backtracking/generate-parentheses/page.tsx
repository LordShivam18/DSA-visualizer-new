...
import Controls from "../../../components/backtracking/generate-parentheses/Controls";
...
import {
  formatParenthesesResults,
  generateTrace,
  parseParenthesesInput,
  type GenerateParenthesesTraceStep,
} from "../../../components/backtracking/generate-parentheses/generateTrace";
...
export default function GenerateParenthesesPage() {
  ...
  const [trace, setTrace] = useState<GenerateParenthesesTraceStep[]>(() =>
  ...
  const normalized = parseParenthesesInput(input);
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6">
        ...
        <header className="mx-auto flex w-full max-w-4xl flex-col items-center gap-4 text-center">
          <p className="text-xs uppercase tracking-[0.34em] text-slate-500">
            Backtracking / Prefix Validity / Balance Constraint
          </p>
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-400 md:text-base">
            Build the string one bracket at a time, but keep every prefix valid
            by never letting closing brackets outnumber opening brackets.
          </p>
        </header>
        ...
        <div className="mx-auto w-full max-w-4xl">
          <div className="glass-card p-5">
            ...
            <div className="mt-3 flex flex-wrap items-center justify-between gap-3 text-xs text-slate-400">
              <span>Normalized pairs: {normalized}</span>
        ...
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(0,0.92fr)]">
          <section className="space-y-5">
            ...
            <GenerateParenthesesWorkbench step={step} />
          ...
          >
            ...
            <div className="rounded-xl bg-slate-950/50 p-4 font-mono text-base">
              <span className={step.done ? "text-emerald-300" : "text-cyan-300"}>
                generateParenthesis(...) = {formatParenthesesResults(step.state.results)}
              </span>
            </div>
