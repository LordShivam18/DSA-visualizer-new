...
import Controls from "../../../components/graph-traversal/clone-graph/Controls";
...
import {
  formatAdjacency,
  generateTrace,
  type CloneGraphTraceStep,
} from "../../../components/graph-traversal/clone-graph/generateTrace";

const defaultInput = `[[2,4],[1,3],[2,4],[1,3]]`;
...
export default function CloneGraphPage() {
  ...
  const [trace, setTrace] = useState<CloneGraphTraceStep[]>(() =>
  ...
  const outputGraph = formatAdjacency(
    step.state.result ??
      [...step.state.cloneNodes]
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6">
        ...
        <header className="mx-auto flex w-full max-w-4xl flex-col items-center gap-4 text-center">
          <p className="text-xs uppercase tracking-[0.34em] text-slate-500">
            Graph Traversal / BFS / Hash Map Cloning
          </p>
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-400 md:text-base">
            Watch BFS walk the original graph, allocate clone nodes lazily, and
            rebuild the same adjacency structure without reusing original references.
          </p>
        </header>
        ...
        <div className="mx-auto w-full max-w-4xl">
          <div className="glass-card p-5">
            ...
            <textarea
              ...
              className="input-field mt-2 min-h-[130px] resize-y"
              placeholder='Use JSON like [[2,4],[1,3],[2,4],[1,3]]'
            />

            <div className="mt-3 flex flex-wrap items-center justify-between gap-3 text-xs text-slate-400">
              <span>
                Accepted format: JSON adjacency list where node values are 1-indexed
              </span>
        ...
        <div className="mx-auto w-full max-w-4xl">
          ...
          >
            ...
            <div className="rounded-xl bg-slate-950/50 p-4 font-mono text-sm leading-7 text-slate-200">
              cloneGraph(adjList) = {outputGraph}
            </div>
